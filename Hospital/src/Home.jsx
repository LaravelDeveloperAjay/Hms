...
<div className="container-fluid relative">
  ...
  <b className='text-6xl'>Grow your business and deliver a  <br />higher standard of care.</b>
 ...
 <div className='p3'><img src="https://shiftcare.com/img/asset/YXNzZXRzL3Jldmlld3MvQXNpYW4tcGVyc29uLWFnZWQtY2FyZS1zb2Z0d2FyZS5qcGVn/Asian-person-aged-care-software.jpeg?q=80&fm=webp&fit=crop-31-27-2.4&w=296&h=296&s=5989b1135b59abeac22b00115d7dcc73" alt="" /></div>
  ...
  <div className="container-fluid mt-10">
    <div className="row">
      ...
      <div className="col-md-6">
        ...
        <div className='mt-3'>        <b className='text-3xl mt-10 text-slate-950'>More time for what matters</b></div>

        <p className='text-xl  mt-3'>ShiftCare’s care management features make it easier for you and your teams to deliver highly personalised support to clients and their families.</p>
        
        <button className='text-blue-700 underline mt-4 text-xl'>Learn more about care management <i class="bi bi-arrow-right"></i></button></div>
      </div>
    </div>
  </div>
  <div className="container-fluid mt-10">
    <div className="row">
      ...
      <div className="col-md-6">
        <div className='mt-36 mx-10'><p className='text-xl'>ROSTERING</p>
        <div className='mt-3'>
        <b className='text-3xl mt-10 text-slate-950'>Team management made easy</b></div>
        <p className='text-xl mt-3'>We’ve made it easy to plan and organise teams, shifts and rosters, helping you deliver a more effective, efficient service.</p>
        
        <button className='text-blue-700 underline mt-4 text-xl'>Learn more about  Rostering<i class="bi bi-arrow-right"></i></button></div>
      </div>
      <div className="col-md-6">
  ...
  <div className="container-fluid mt-10">
    <div className="row">
      ...
      <div className="col-md-6">
        <div className='mt-36 mx-10'><p className='text-xl'>INVOICING</p>
        <div className='mt-3'>
        <b className='text-3xl mt-10 text-slate-950'>Simplify accounting and boost efficiency</b></div>
        <p className='text-xl mt-3'>With the management of invoices, timesheets and expenses seamlessly integrated, along with NDIS pricing, ShiftCare makes accurate accounting simple, reducing your workload, and helping you grow.</p>
        
        <button className='text-blue-700 underline mt-4 text-xl'>Learn more about invoicing<i class="bi bi-arrow-right"></i></button></div>
      </div>
    </div>
  </div>
  <div className="container-fluid mt-10">
    <div className="row">
      ...
      <div className="col-md-6">
        <div className='mt-24 mx-10'><p className='text-xl'>SHIFTCARE APP</p>
        <div className='mt-3'></div>
        <b className='text-3xl mt-10 text-slate-950'>Support on the go</b>
        <p className='text-xl mt-3'>We connect you and your teams with all you need to manage shifts, co-ordinate clients and deliver quality care, wherever they are.</p>
        
        
        <button className='text-blue-700 underline mt-4 text-xl'>Learn how the Shiftcare app works<i class="bi bi-arrow-right"></i></button></div>
      </div>
      <div className="col-md-6">
...
Aged Care</b>
  ...
  <div className="container-fluid mt-10">
    <div className="row">
      <div className="col-md-6">
        ...
        <b className='text-4xl mt-10 text-slate-950'>ShiftCare Support Worker of the Year</b>
  ...
  <ul className='flex justify-center items-center gap-10'>
    ...
    <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></p></li>
    <li ><img src="https://shiftcare.com/assets/companies/xero.svg" alt="" />
    <p className='mx-10 mt-4'>
    <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></p></li>
    <li ><img src="https://shiftcare.com/assets/companies/google.svg" alt="" />
  ...
  <div className="container-fluid mt-20 star">
    <div className="row">
      ...
      <div className=' p-5 bg-slate-300'><p>In audit and compliance,We've got everything now.if we have any query about what we're doing,it's just at the tip of a finger.</p>
        <b> Clover Laurier</b> <div className='mt-4'></div>
  ...
  <div className="container-fluid mt-10 star">
    <div className="row">
      ...
      <div className=' p-5 bg-slate-300'><p className='mt-4'>When a caregiver cancelled a shift on me, it used to take us 2 hours to find a replacement, now it takes me minutes with ShiftCare.</p>
        <b>Olena</b> <div className='mt-4'></div>
      ...
      <div className=' p-5 bg-slate-300'><p>The admin that took a full day now gets done in about an hour. It's definitely caused a lot less stress. I'm very busy, and it has given me time to focus on more important things.</p>
        <b>Alana</b> <div className='mt-4'></div>
      ...
      <div className=' p-4 bg-slate-300'><p>My business has been with Shiftcare for around two years. It is a fantastic system. I save so much time in regards to rostering, sending invoices, staff management, and so much more. It also communicates with my accounting software with a few clicks of a button. I highly recommend Shiftcare.</p>
        <b>Ricky Mc</b> <div className='mt-4'></div>
  ...
  <p className='text-center text-xl mt-20'>BADGES OF EXCELLENCE</p>
  <div className="container-fluid">
    <div className='flex mt-20 gap-20  justify-center captera'>
      <div><img src="https://shiftcare.com/img/asset/YXNzZXRzL2JhZGdlcy9jYS1lYXNlX29mX3VzZS0yMDI0LnBuZw==/ca-ease_of_use-2024.png?fm=webp&q=90&fit=crop-50-50&w=469&h=438&s=a37d0e5195fdafaa7ae0210c1b320ae5" alt="" /></div>
      <div><img src="https://shiftcare.com/img/asset/YXNzZXRzL2JhZGdlcy9zYS1jdXN0b21lcl9zdXBwb3J0LTIwMjQucG5n/sa-customer_support-2024.png?fm=webp&q=90&fit=crop-50-50&w=345&h=363&s=85fc1c006182deafefcc4af3de2c0198" alt="" /></div>
      <div><img src="https://shiftcare.com/img/asset/YXNzZXRzL2JhZGdlcy9ob21lY2FyZWFnZW5jeW1hbmFnZW1lbnRfYmVzdGVzdGltYXRlZHJvaV9yb2ktMTcxNTY1MTM0Ny5wbmc=/homecareagencymanagement_bestestimatedroi_roi-1715651347.png?fm=webp&q=90&fit=crop-50-50&w=770&h=1000&s=840f4074b22ae6ebc6b70e3c902681cc" alt=""   /></div>
      <div><img src="https://shiftcare.com/img/asset/YXNzZXRzL2JhZGdlcy9zYS1jdXN0b21lcl9zdXBwb3J0LTIwMjQucG5n/sa-customer_support-2024.png?fm=webp&q=90&fit=crop-50-50&w=345&h=363&s=85fc1c006182deafefcc4af3de2c0198" alt="" /></div>
      <div><img src="https://shiftcare.com/img/asset/YXNzZXRzL2JhZGdlcy9jYS1lYXNlX29mX3VzZS0yMDI0LnBuZw==/ca-ease_of_use-2024.png?fm=webp&q=90&fit=crop-50-50&w=469&h=438&s=a37d0e5195fdafaa7ae0210c1b320ae5" alt="" /></div>
    </div>
  </div>
  ...
  <div className="container-fluid mt-36 border-b-4 cursor-pointer">
    <div className="row">
